...
public class CreateCmd implements ICommand {
    ...
    public String getHelpMessage() {
        return "Creer une competition de type league.\n" +
                "S'utilise ainsi: \"league create <nom:String> <edition:String> <sport:String> <zone_geo:String> <nb_confrontations:Integer>\"";
    }

    @Override
    public void run(CommandContext cmdContext) {
        if (cmdContext.args.length == 5) {
            ...
            System.out.println("La commande entree demande exactement 5 arguments.");
        }
    }
